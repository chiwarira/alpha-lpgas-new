"""
Django settings for Alpha LPGas project.
"""
...
# CORS Settings
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:3001,http://localhost:3002,http://localhost:3003,http://127.0.0.1:3000,http://127.0.0.1:3001,http://127.0.0.1:3002,http://127.0.0.1:3003').split(',')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='info@alphalpgas.co.za')
...
WAGTAILADMIN_BASE_URL = config('SITE_URL', default='http://localhost:8000')

# DRF Spectacular Settings
SPECTACULAR_SETTINGS = {
    'TITLE': 'Alpha LPGas API',
    'DESCRIPTION': 'API for Alpha LPGas gas delivery and accounting system',
    'VERSION': '1.0.0',
...
YOCO_WEBHOOK_SECRET = config('YOCO_WEBHOOK_SECRET', default='')
